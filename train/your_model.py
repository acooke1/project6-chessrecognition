...
class YourModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.architecture = [
        # Block 1
        Conv2D(8, 3, 1, padding="same", activation="relu", name="block1_conv1"),
        Conv2D(8, 3, 1, padding="same", activation="relu", name="block1_conv2"),
        MaxPool2D(2, name="block1_pool"),
        # Block 2
        Conv2D(16, 3, 1, padding="same", activation="relu", name="block2_conv1"),
        Conv2D(16, 3, 1, padding="same", activation="relu", name="block2_conv2"),
        MaxPool2D(2, name="block2_pool"),
        # Block 3
        Conv2D(32, 3, 1, padding="same", activation="relu", name="block3_conv1"),
